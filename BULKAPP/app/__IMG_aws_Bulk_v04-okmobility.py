...
class IMG_aws_TAG_Bulk:
            ...
            for item in f_data:
                ...
                for i, s in enumerate(sizes):
                    ...
                    if item["type"] == "link":
                        ...
                        item["aws_path_1"] + s + item["aws_path_2"] + \
                        '?n_o_ct=[CLICKURL]' + link + '" width="' + width + '" height="' + height + \
    ...
    def set_url_or_link(self, href, tcs, i, type, url_param_sep="", utm_size=""):
        ...
        if type == "link" and href.lower() == "only_tc":
            ...
            return param + 'https://neural82.cdnwebcloud.com/atc?tc=' + tch10 + '&n_o_p=v1mp&n_o_ord=&[CACHEBUSTER]&url_n_o=' + href + url_param_sep + utm_size + tc
